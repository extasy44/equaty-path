          ...
          <div className="grid gap-6 mt-6">
            ...
            <Card className="ring-1 ring-black/5">
              ...
              <CardContent className="text-sm text-muted-foreground grid gap-2">
                <div>
                  ...
                  maintenance, and depreciation) exceed rental income. The net loss can reduce
                  taxable income at your marginal tax rate.
                </div>
                <div>
                  <span className="font-medium text-foreground">Positive gearing</span> occurs when
                  rental income exceeds property expenses. The net profit is added to taxable income
            ...
            <Card className="ring-1 ring-black/5">
              ...
              <CardContent className="text-sm text-muted-foreground grid gap-2">
                ...
                <div>
                  - Positive gearing: net profit increases taxable income; consider buffers for rate
                  and expense changes.
                </div>
                <div>
