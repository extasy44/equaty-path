...
function CompareContent() {
  ...
  const meta = pageMetadata.compare
          ...
          <div className="mt-8 grid gap-8">
            <Section>
              ...
              <CardContent className="text-sm text-muted-foreground">
                With EquityPath Compare, you can benchmark multiple options side by side — from
                suburbs and builders to rental vs rebuild strategies. Make better decisions with
            ...
            <div className="text-center">
              <div className="inline-flex gap-2">
                ...
                <div className="text-xs text-muted-foreground self-center ml-2">
                  💡 Premium reports available in Reports section
                </div>
              </div>
            </div>
          </div>
